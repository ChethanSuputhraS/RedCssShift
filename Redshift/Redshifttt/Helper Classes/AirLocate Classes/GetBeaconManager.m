...
//    for (int kl=0; kl<[uuidsArr count]; kl++)
//    {
////        NSLog(@"uuidsArr listttt == %@",[[uuidsArr objectAtIndex:kl] objectForKey:@"uuid"]);
//
//        NSUUID *uuid =[[NSUUID alloc] initWithUUIDString:[[uuidsArr objectAtIndex:kl] objectForKey:@"uuid"]];
//        
